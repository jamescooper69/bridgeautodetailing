      ...
      <div className="container-custom py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <Link to="/interior-detailing" className="text-foreground hover:text-primary font-medium">
              Interior Detailing
            </Link>
            <Link to="/exterior-detailing" className="text-foreground hover:text-primary font-medium">
              Exterior Detailing
            </Link>
            <Link to="/complete-detailing" className="text-foreground hover:text-primary font-medium">
